...
class Options():
    ...
    def init(self, parser):        
        # global settings
        parser.add_argument('--batch_size', type=int, default=1, help='batch size')   #这里原本是32
        parser.add_argument('--nepoch', type=int, default=250, help='training epochs')
        parser.add_argument('--train_workers', type=int, default=0, help='train_dataloader workers')    #这两个worker本来都是4
        ...
        parser.add_argument('--gpu', type=str, default='0', help='GPUs')      #我自己的电脑只有一块gpu所以default='1'，
        ...
        #action='store_true' 意味着如果命令行中包含 --distribute 参数，则 args.distribute 的值将被设置为 True，否则将被设置为 False。
